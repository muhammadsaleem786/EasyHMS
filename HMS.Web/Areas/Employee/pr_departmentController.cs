...
//{
//    [JwtAuthentication]
//    public class pr_departmentController : ApiController, IERPAPIInterface<pr_department>, IDisposable
//    {
//        private readonly Ipr_departmentService _service;
//        private readonly Ipr_employee_mfService _pr_employee_mfService;
//        private readonly IUnitOfWorkAsync _unitOfWorkAsync;

//        public pr_departmentController(IUnitOfWorkAsync unitOfWorkAsync, Ipr_departmentService Service, Ipr_employee_mfService pr_employee_mfService)
//        {
...
//        public async Task<ResponseInfo> Save(pr_department Model)
//        {
//            //int a
...
//                pr_department dept = _service.Queryable().Where(x => x.CompanyID == CompanyID && x.DepartmentName.ToLower() == Model.DepartmentName.ToLower()).FirstOrDefault();
//                if (dept == null)
//                {
...
//        public async Task<ResponseInfo> SaveAndReturnDeptList(pr_department Model)
//        {
//            var objResponse = new ResponseInfo();
//            try
//            {
...
//                        {
//                            ID = Model.ID,
//                            DepartmentList = _service.Queryable().Where(x => x.CompanyID == CompanyID).Select(x => new { ID = x.ID, DepartmentName = x.DepartmentName }).ToList(),
//                        };
//                    }
//                    catch (DbUpdateException)
//                    {
...
//                    .Select(x => new { x.ID, x.DepartmentName, x.CompanyID, x.CreatedDate, x.CreatedBy, Employees = x.pr_employee_mf.Count() }).FirstOrDefault();
//            }
//            catch (Exception ex)
//            {
//                objResponse.IsSuccess = false;
...
//        [HttpGet]
//        [ActionName("Update")]
//        public async Task<ResponseInfo> Update(pr_department Model)
//        {
...
//                decimal CompanyID = Request.CompanyID();
//                pr_department dept = _service.Queryable().Where(x => x.CompanyID == CompanyID && x.ID != Model.ID && x.ID != Model.ID && x.DepartmentName.ToLower() == Model.DepartmentName.ToLower()).FirstOrDefault();
//                if (dept == null)
//                {
...
//                List<pr_department> Models = _service.Queryable().Where(e => e.CompanyID == CompanyID && IdList.Contains(e.ID)).ToList();
