...
//{
//    [JwtAuthentication]
//    public class pr_payscheduleController : ApiController, IERPAPIInterface<pr_pay_schedule>, IDisposable
//    {
//        private readonly Ipr_pay_scheduleService _service;
//        private readonly IUnitOfWorkAsync _unitOfWorkAsync;

//        public pr_payscheduleController(IUnitOfWorkAsync unitOfWorkAsync, Ipr_pay_scheduleService Service)
//        {
//            _unitOfWorkAsync = unitOfWorkAsync;
//            _service = Service;
//        }
//        public async Task<ResponseInfo> Save(pr_pay_schedule Model)
//        {
...
//                pr_pay_schedule schedule = _service.Queryable().Where(x => x.CompanyID == CompanyID && x.ScheduleName.ToLower() == Model.ScheduleName.ToLower()).FirstOrDefault();
//                if (schedule == null)
//                {
//                    decimal ID = 1;
...
//                    Model.FallInHolidayDropDownID = (int)sys_dropdown_mfEnum.PayDayFallOnHoliday;
...
//                {
//                    objResponse.IsSuccess = false;
//                    objResponse.ErrorMessage = Model.ScheduleName + " already exist. Please enter a different name and try again.";
//                }
...
//        public async Task<ResponseInfo> SaveAndReturnPayScheduleList(pr_pay_schedule Model)
//        {
//            var objResponse = new ResponseInfo();
//            try
//            {
...
//                        {
//                            ID = Model.ID,
//                            PaySchedules = _service.Queryable().Where(x => x.CompanyID == CompanyID).Select(x => new { ID = x.ID, ScheduleName = x.ScheduleName }).ToList(),
//                        };
//                    }
//                    catch (DbUpdateException)
//                    {
...
//        [HttpGet]
//        [ActionName("Update")]
//        public async Task<ResponseInfo> Update(pr_pay_schedule Model)
//        {
...
//                }
//                decimal CompanyID = Request.CompanyID();
//                pr_pay_schedule schedule = _service.Queryable().Where(x => x.CompanyID == CompanyID && x.ID != Model.ID && x.ScheduleName.ToLower() == Model.ScheduleName.ToLower()).FirstOrDefault();
//                if (schedule == null)
//                {
//                    Model.ModifiedBy = Request.LoginID();
//                    Model.ModifiedDate = Request.DateTimes();
...
//                List<pr_pay_schedule> Models = _service.Queryable().Where(e => e.CompanyID == CompanyID && IdList.Contains(e.ID)).ToList();
