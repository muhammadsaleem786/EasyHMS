...
//{
//    [JwtAuthentication]
//    public class pr_designationController : ApiController, IERPAPIInterface<pr_designation>, IDisposable
//    {
//        private readonly Ipr_designationService _service;
//        private readonly Ipr_employee_mfService _pr_employee_mfService;
//        private readonly IUnitOfWorkAsync _unitOfWorkAsync;

//        public pr_designationController(IUnitOfWorkAsync unitOfWorkAsync, Ipr_designationService Service, Ipr_employee_mfService pr_employee_mfService)
//        {
...
//        public async Task<ResponseInfo> Save(pr_designation Model)
//        {
...
//                pr_designation desgn = _service.Queryable().Where(x => x.CompanyID == CompanyID && x.DesignationName.ToLower() == Model.DesignationName.ToLower()).FirstOrDefault();
//                if (desgn == null)
//                {
...
//                {
//                    objResponse.IsSuccess = false;
//                    objResponse.ErrorMessage = Model.DesignationName + " already exist. Please enter a different name and try again.";
//                }
//            }
//            catch (Exception ex)
//            {
...
//        public async Task<ResponseInfo> SaveAndReturnDesignationList(pr_designation Model)
//        {
//            var objResponse = new ResponseInfo();
//            try
//            {
...
//                        {
//                            ID = Model.ID,
//                            DesignationList = _service.Queryable().Where(x => x.CompanyID == CompanyID).Select(x => new { ID = x.ID, DesignationName = x.DesignationName }).ToList(),
//                        };
//                    }
//                    catch (DbUpdateException)
//                    {
...
//                    .Include(x => x.pr_employee_mf)
//                    .Select(x => new { x.ID, x.DesignationName, x.CompanyID, x.CreatedBy, x.CreatedDate, Employees = x.pr_employee_mf.Count() }).FirstOrDefault();
//            }
//            catch (Exception ex)
//            {
//                objResponse.IsSuccess = false;
...
//        [HttpGet]
//        [ActionName("Update")]
//        public async Task<ResponseInfo> Update(pr_designation Model)
//        {
...
//                }
//                decimal CompanyID = Request.CompanyID();
//                pr_designation design = _service.Queryable().Where(x => x.CompanyID == CompanyID && x.ID != Model.ID && x.DesignationName.ToLower() == Model.DesignationName.ToLower()).FirstOrDefault();
//                if (design == null)
//                {
...
//                List<pr_designation> Models = _service.Queryable().Where(e => e.CompanyID == CompanyID && IdList.Contains(e.ID)).ToList();
