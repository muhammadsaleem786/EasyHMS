...
{
    public class emr_prescription_observationMap : EntityTypeConfiguration<emr_prescription_observation>
    {
        public emr_prescription_observationMap()
        {
            // Primary Key
            ...
            this.ToTable("emr_prescription_observation");
            ...
            this.HasRequired(t => t.adm_company)
                .WithMany(t => t.emr_prescription_observation)
                .HasForeignKey(d => d.CompanyID);
            this.HasRequired(t => t.adm_user_mf)
                .WithMany(t => t.emr_prescription_observation)
                .HasForeignKey(d => d.ModifiedBy);
            this.HasRequired(t => t.adm_user_mf1)
                .WithMany(t => t.emr_prescription_observation1)
                .HasForeignKey(d => d.ModifiedBy);
