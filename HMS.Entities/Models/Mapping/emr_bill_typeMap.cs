...
{
    public class emr_bill_typeMap : EntityTypeConfiguration<emr_bill_type>
    {
        public emr_bill_typeMap()
        {
            // Primary Key
