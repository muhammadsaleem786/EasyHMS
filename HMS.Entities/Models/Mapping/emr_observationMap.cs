...
{
    public class emr_observationMap : EntityTypeConfiguration<emr_observation>
    {
        public emr_observationMap()
        {
            // Primary Key
            ...
            this.HasRequired(t => t.adm_user_mf)
                .WithMany(t => t.emr_observation)
                .HasForeignKey(d => d.CreatedBy);
            this.HasRequired(t => t.adm_user_mf1)
                .WithMany(t => t.emr_observation1)
