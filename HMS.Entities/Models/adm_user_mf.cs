...
namespace HMS.Entities.Models
{
    public partial class adm_user_mf : Entity
    {
        public adm_user_mf()
        {
            ...
            this.emr_expense1 = new List<emr_expense>(); this.emr_income = new List<emr_income>();
            ...
            this.emr_bill_type1 = new List<emr_bill_type>();
        ...
        public virtual ICollection<emr_bill_type> emr_bill_type1 { get; set; }
