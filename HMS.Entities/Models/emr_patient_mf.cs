...
namespace HMS.Entities.Models
{
    public partial class emr_patient_mf : Entity
    {
        ...
        public Boolean Illness_Diabetes { get; set; }
        public Boolean Illness_Tuberculosis { get; set; }
        public Boolean Illness_HeartPatient { get; set; }
        public Boolean Illness_LungsRelated { get; set; }
        public Boolean Illness_BloodPressure { get; set; }
        public Boolean Illness_Migraine { get; set; }
